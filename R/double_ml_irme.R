...
#'
#' @export
DoubleMLIRME = R6Class("DoubleMLIRME",
  inherit = DoubleML,
  active = list(
  ...
  public = list(
    ...
    initialize = function(data,
      ...
      dml_procedure = "dml2", # Why is the default dml1?
  ...
  private = list(
    ...
    score_elements = function(y, d, d1, g0_hat, g1_hat, m_hat, m1_hat, smpls) {
      ...
      if (is.character(self$score)) {
        # compute residuals
        u0_hat = y - g0_hat
        # TODO Change code also for the other effects.
        if (self$score == "ATE") {
          u1_hat = y - g1_hat
    ...
    nuisance_tuning = function(smpls, param_set, tune_settings,
      ...
      tuning_result_m1 = dml_tune(self$learner$ml_m,
                                 c(self$data$x_cols),
      ...
      tuning_result = list(
        ...
        "ml_m1" = list(tuning_result_m1, params = tuning_result_m1$params))
